...
class Db
{
    ...
    {
        $this->getConnection()->exec('create table if not exists `users` (id int not null primary key auto_increment, email varchar(250) not null, name varchar(250) not null, password varchar(250) not null, created_at date)');
    }

    public function createMessagesTable():void
   {
       $this->getConnection()->exec('create table if not exists `messages` (id int not null primary key auto_increment, text varchar(250) not null, author_id int not null, created_at date not null, image varchar(250))');
   }
...
//    public function createUserTable():void
//    {
//        $this->getConnection()->exec('create table if not exists `users` (id int not null primary key auto_increment, email varchar(250) not null, name varchar(250) not null, password varchar(250) not null, created_at date, gender int not null)');
//    }
//
//    public function createMessagesTable():void
//    {
